...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 8.67795276; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = 5.35275578; // in; offset of the lateral wheel
